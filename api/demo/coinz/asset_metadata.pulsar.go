...
var (
	...
	fd_AssetMetadata_asset protoreflect.FieldDescriptor
)

func init() {
	file_demo_coinz_asset_metadata_proto_init()
	md_AssetMetadata = File_demo_coinz_asset_metadata_proto.Messages().ByName("AssetMetadata")
	fd_AssetMetadata_asset = md_AssetMetadata.Fields().ByName("asset")
}
...
func (x *AssetMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_demo_coinz_asset_metadata_proto_msgTypes[0]
...
func (x *fastReflection_AssetMetadata) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Asset != nil {
		...
		if !f(fd_AssetMetadata_asset, value) {
			return
		}
	}
}
...
func (x *fastReflection_AssetMetadata) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "demo.coinz.AssetMetadata.asset":
		return x.Asset != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: demo.coinz.AssetMetadata"))
		}
		panic(fmt.Errorf("message demo.coinz.AssetMetadata does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AssetMetadata) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message demo.coinz.AssetMetadata does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AssetMetadata) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in demo.coinz.AssetMetadata", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: demo/coinz/asset_metadata.proto
...
type AssetMetadata struct {
	...
	Asset *v1beta1.Coin `protobuf:"bytes,1,opt,name=asset,proto3" json:"asset,omitempty"`
}
...
func (*AssetMetadata) Descriptor() ([]byte, []int) {
	return file_demo_coinz_asset_metadata_proto_rawDescGZIP(), []int{0}
}

func (x *AssetMetadata) GetAsset() *v1beta1.Coin {
	if x != nil {
		return x.Asset
	}
	return nil
...
var File_demo_coinz_asset_metadata_proto protoreflect.FileDescriptor

var file_demo_coinz_asset_metadata_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x7a, 0x2f, 0x61, 0x73, 0x73,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x46, 0x0a, 0x0d, 0x41, 0x73, 0x73, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x18, 0x01, 0x20,
	...
	0xc8, 0xde, 0x1f, 0x00, 0x52, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x42, 0x94, 0x01, 0x0a, 0x0e,
	0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x7a, 0x42, 0x12,
	0x41, 0x73, 0x73, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x50, 0x72, 0x6f,
...
var (
	file_demo_coinz_asset_metadata_proto_rawDescOnce sync.Once
	file_demo_coinz_asset_metadata_proto_rawDescData = file_demo_coinz_asset_metadata_proto_rawDesc
)

func file_demo_coinz_asset_metadata_proto_rawDescGZIP() []byte {
	file_demo_coinz_asset_metadata_proto_rawDescOnce.Do(func() {
		file_demo_coinz_asset_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(file_demo_coinz_asset_metadata_proto_rawDescData)
	})
	return file_demo_coinz_asset_metadata_proto_rawDescData
}

var file_demo_coinz_asset_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_demo_coinz_asset_metadata_proto_goTypes = []interface{}{
	(*AssetMetadata)(nil), // 0: demo.coinz.AssetMetadata
	(*v1beta1.Coin)(nil),  // 1: cosmos.base.v1beta1.Coin
}
var file_demo_coinz_asset_metadata_proto_depIdxs = []int32{
	1, // 0: demo.coinz.AssetMetadata.asset:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_demo_coinz_asset_metadata_proto_init() }
func file_demo_coinz_asset_metadata_proto_init() {
	if File_demo_coinz_asset_metadata_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_demo_coinz_asset_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_demo_coinz_asset_metadata_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_demo_coinz_asset_metadata_proto_goTypes,
		DependencyIndexes: file_demo_coinz_asset_metadata_proto_depIdxs,
		MessageInfos:      file_demo_coinz_asset_metadata_proto_msgTypes,
	}.Build()
	File_demo_coinz_asset_metadata_proto = out.File
	file_demo_coinz_asset_metadata_proto_rawDesc = nil
	file_demo_coinz_asset_metadata_proto_goTypes = nil
	file_demo_coinz_asset_metadata_proto_depIdxs = nil
}
